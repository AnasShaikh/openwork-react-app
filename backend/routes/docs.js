...
router.get('/contracts', (req, res) => {
  res.json({
    ...
    publicDocsUrl: CONTRACT_REGISTRY.publicDocsUrl,
    summary: CONTRACT_REGISTRY.summary,
    auditedBlocks: CONTRACT_REGISTRY.auditedBlocks,
    statusDefinitions: CONTRACT_REGISTRY.statusDefinitions,
    configurationByContract: CONTRACT_REGISTRY.configurationByContract,
    liveConfiguration: CONTRACT_REGISTRY.liveConfiguration,
    recentChanges: CONTRACT_REGISTRY.recentChanges,
    limitations: CONTRACT_REGISTRY.limitations,
