    ...
    UUPSUpgradeable
{
    ...
    function processFeePayment(
        ...
        // ENABLED: Resolve disputed job funds after fee distribution
    ...
    function _resolveDisputedFunds(string memory _disputeId, bool _winningSide) internal {
        ...
        if (winner != address(0)) {
            ...
            // For now, always use native chain (Arbitrum = domain 3)
            // TODO: Implement proper chain domain detection for cross-chain winners
            winnerChainDomain = 3;
            
            // Call NOWJC with correct 3-parameter interface
