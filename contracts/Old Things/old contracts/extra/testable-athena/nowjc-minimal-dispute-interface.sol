    ...
    UUPSUpgradeable
{
    ...
    /**
     * @dev Simplified interface for Native Athena to release disputed funds
     * @param _recipient Address to receive the funds
     * @param _amount Amount to transfer
     * @param _targetChainDomain Chain domain (3=Arbitrum native, 2=OP Sepolia, 0=Ethereum)
     */
    function releaseDisputedFunds(
        ...
        if (_targetChainDomain == 3) {
            ...
            usdtToken.safeTransfer(cctpTransceiver, _amount);
            ICCTPTransceiver(cctpTransceiver).sendFast(
                _amount,
                _targetChainDomain,
