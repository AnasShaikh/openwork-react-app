 ...
 * @notice Fixed for genesis deployment - uses fallback owner logic
 */
contract OpenworkGenesis {
    ...
    modifier onlyOwner() {
        require(msg.sender == owner || (owner == address(0) && msg.sender == 0xfD08836eeE6242092a9c869237a8d122275b024A), "Not owner");
        _;
    }
    ...
    modifier onlyAuthorized() {
        require(
            ...
            msg.sender == owner || 
            (owner == address(0) && msg.sender == 0xfD08836eeE6242092a9c869237a8d122275b024A), 
            "Not authorized"
        );
        _;
    }
    ...
    function initialize() external {
        ...
        require(msg.sender == 0xfD08836eeE6242092a9c869237a8d122275b024A, "Only genesis owner can initialize");
    ...
    function setDispute(
        ...
        emit DisputeSet(jobId, disputeRaiser, fees);
    }
    ...
    function updateDisputeVotes(string memory disputeId, uint256 votesFor, uint256 votesAgainst) external onlyAuthorized {
        ...
        emit DisputeVotesUpdated(disputeId, votesFor, votesAgainst);
    }
    ...
    function setDisputeVote(string memory disputeId, address voter) external onlyAuthorized {
        ...
        emit DisputeVoteSet(disputeId, voter);
    }
    ...
    function setSkillApplication(
        ...
        emit SkillAppSet(applicationId, applicant, targetOracleName);
    }
    ...
    function updateSkillApplicationVotes(uint256 applicationId, uint256 votesFor, uint256 votesAgainst) external onlyAuthorized {
        ...
        emit SkillVotesUpdated(applicationId, votesFor, votesAgainst);
    }
    ...
    function setSkillApplicationVote(uint256 applicationId, address voter) external onlyAuthorized {
        ...
        emit SkillVoteSet(applicationId, voter);
    }
    ...
    function setAskAthenaApplication(
        ...
        emit AthenaAppSet(athenaId, applicant, targetOracle);
    }
    ...
    function addDisputeVoter(
        ...
        emit DisputeVoterAdded(disputeId, voter, claimAddress);
    }
    ...
    function addSkillVerificationVoter(
        ...
        emit SkillVoterAdded(applicationId, voter, claimAddress);
    }
    ...
    function addAskAthenaVoter(
        ...
        emit AthenaVoterAdded(athenaId, voter, claimAddress);
    }
    ...
    function setStake(
        ...
        emit StakeUpdated(staker, amount, isActive);
    }
    ...
    function setDelegate(address delegator, address delegatee) external onlyAuthorized {
        ...
        emit DelegateSet(delegator, delegatee);
    }
    ...
    function setDelegatedVotingPower(address delegatee, uint256 power) external onlyAuthorized {
        ...
        emit DelegatePowerUpdated(delegatee, power);
    }
    ...
    function updateDelegatedVotingPower(address delegatee, uint256 powerChange, bool increase) external onlyAuthorized {
        ...
        emit DelegatePowerUpdated(delegatee, delegatedVotingPower[delegatee]);
    }
    ...
    function updateUserClaimData(address user, uint256 claimedAmount) external onlyAuthorized {
        ...
        emit ClaimDataUpdated(user, claimedAmount);
    }
