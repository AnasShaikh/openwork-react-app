    ...
    UUPSUpgradeable
{
    ...
    function releasePaymentCrossChain(
        ...
        // Send USDC directly via CCTP transceiver to target chain
        // The transceiver already has USDC from previous CCTP transfers
        ICCTPTransceiver(cctpTransceiver).sendFast(
            ...
            0                    // maxFee (0 for now, can be adjusted)
        );
