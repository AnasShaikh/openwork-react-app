...
```bash
cast call 0xaf88d065e77c8cC2239327C5EDb3A432268e5831 "balanceOf(address)(uint256)" 0xfD08836eeE6242092a9c869237a8d122275b024A --rpc-url https://arb-mainnet.g.alchemy.com/v2/YOUR-ALCHEMY-KEY
```
**Result**: `2892594` (2.892594 USDC available)

### Step 2: Approve USDC Spending
```bash
cast send 0xaf88d065e77c8cC2239327C5EDb3A432268e5831 "approve(address,uint256)" 0xA4Ec15F2dFDF999912Ff2843fB5A2e6FDc5b7B8F 1000000 --rpc-url https://arb-mainnet.g.alchemy.com/v2/YOUR-ALCHEMY-KEY --private-key 0x0720f50ce9cdedb2677f92f40fa9b6eea44fe60508b01eebdcd25500728c71ea
```
**Result**: ✅ Success  
...
```bash
cast send 0xA4Ec15F2dFDF999912Ff2843fB5A2e6FDc5b7B8F "sendFast(uint256,uint32,bytes32,uint256)" 500000 2 0x000000000000000000000000fd08836eee6242092a9c869237a8d122275b024a 1000 --rpc-url https://arb-mainnet.g.alchemy.com/v2/YOUR-ALCHEMY-KEY --private-key 0x0720f50ce9cdedb2677f92f40fa9b6eea44fe60508b01eebdcd25500728c71ea
```
**Result**: ✅ Success  
...
```bash
cast call 0x0b2C639c533813f4Aa9D7837CAf62653d097Ff85 "balanceOf(address)" 0xfD08836eeE6242092a9c869237a8d122275b024A --rpc-url https://opt-mainnet.g.alchemy.com/v2/YOUR-ALCHEMY-KEY
```
