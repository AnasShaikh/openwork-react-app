...
```bash
cast send 0x0b2C639c533813f4Aa9D7837CAf62653d097Ff85 "approve(address,uint256)" 0x3C9D9A5F571F040ed7863A0C727f34d5Ee3Ce7f6 1000 --rpc-url https://opt-mainnet.g.alchemy.com/v2/YOUR-ALCHEMY-KEY --private-key 0x0720f50ce9cdedb2677f92f40fa9b6eea44fe60508b01eebdcd25500728c71ea
```
**Result**: ✅ Success  
