...
forge create --broadcast \
  ...
  --rpc-url https://eth-mainnet.g.alchemy.com/v2/YOUR-ALCHEMY-KEY \
...
```bash
cast call 0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48 "balanceOf(address)" 0xfD08836eeE6242092a9c869237a8d122275b024A --rpc-url https://eth-mainnet.g.alchemy.com/v2/YOUR-ALCHEMY-KEY
```
**Result**: `0x292fc6` = `2,699,206` wei (2.699206 USDC available)

### Step 2: Approve USDC Spending
```bash
cast send 0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48 "approve(address,uint256)" 0x9F390a362D924b051A3EaC23E5281cA256E431c8 1000 --rpc-url https://eth-mainnet.g.alchemy.com/v2/YOUR-ALCHEMY-KEY --private-key 0x0720f50ce9cdedb2677f92f40fa9b6eea44fe60508b01eebdcd25500728c71ea
```
**Result**: ✅ Success  
...
```bash
cast call 0xaf88d065e77c8cC2239327C5EDb3A432268e5831 "balanceOf(address)" 0xfD08836eeE6242092a9c869237a8d122275b024A --rpc-url https://arb-mainnet.g.alchemy.com/v2/YOUR-ALCHEMY-KEY
```
