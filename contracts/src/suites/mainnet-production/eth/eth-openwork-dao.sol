    ...
    UUPSUpgradeable
{
    ...
    event StakeCreated(address indexed staker, uint256 amount, uint256 durationYears);
    ...
    /// @param durationYears Lock duration in years (1, 2, or 3)
    ...
    function stake(
        ...
        stakes[msg.sender] = Stake({
            amount: amount,
            unlockTime: block.timestamp + (durationYears * 365 days),
        ...
        emit StakeCreated(msg.sender, amount, durationYears);
