...
/**
 * @title NativeArbOpenWorkJobContract (v4)
 ...
 *
 * v4 changes:
 *  - Added setJobCounter() admin function to fix jobCounter desync after Mar 19 redeployment
 *
...
/// @title NativeArbOpenWorkJobContract V5
/// @notice Versioned successor to the deployed V4 implementation with corrected job lifecycle validation.
contract NativeArbOpenWorkJobContractV5 is
    Initializable,
