 ...
 * Architecture:
 * - Native Chain (Arbitrum): Data hub plus direct, write-capable adapters
...
export const MAINNET_CHAIN_CONFIG = {
  ...
  42161: {
    ...
    contracts: {
      ...
      // Environment variables may override them for an explicitly coordinated upgrade.
      lowjc: import.meta.env.VITE_NATIVE_ARB_LOWJC_ADDRESS || '0x5727cA7326032a8644a49dECECB8388BEF122bef',
