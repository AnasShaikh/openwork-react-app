...
### Arbitrum One (Chain ID: 42161) — Native data hub + direct writes
- Arb LOWJC frontend adapter: ${arb?.contracts?.lowjc || 'N/A'}
- Arb Athena Client frontend adapter: ${arb?.contracts?.athenaClient || 'N/A'}
