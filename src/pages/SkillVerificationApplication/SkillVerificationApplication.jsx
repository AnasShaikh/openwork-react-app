      ...
      <div className="release-payment-container">
        ...
        <div className="form-header">
          <div style={{display:'flex', gap:25}}>
            ...
            <div className="titleText" style={{fontSize:20}}>Skill Verification Application</div>
          </div>
          ...
          <div className="form-body">
            ...
            <div className="profile-about-item">
                <span>SKILL TO BE VERIFIED</span>
            ...
            <div className="form-groupDC" style={{marginBottom:7}}>
